...
Resources: 
    ...
    https://www.geeksforgeeks.org/find-root-of-a-number-using-newtons-method/
        ...
        2. Ask the user the define how many iterations of Newton's method should be used to approximate
        3. Ask the user to set a tolerance level within which the answer is acceptable. 
    I have chosen the third approach (first approach is commented out at the bottom of this file)
'''

# prompt user to input positive floating point number
...
# prompt user to input a tolerance level (i.e. acceptable proximity of final iteration of Newton's method to previous approximation)
...
def sqrt(num):
    ...
    while abs(refine - approx) >= tolerance: # for method 1, this line could be replaced  with: while refine != approx:
        approx = refine 
        refine = (approx + (num/approx))/2
